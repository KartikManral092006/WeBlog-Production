...
type StarButtonNativeProps = React.ButtonHTMLAttributes<HTMLButtonElement>;
...
export function StarButton({
  ...
  className,
  ...props
}: StarButtonProps & StarButtonNativeProps) {
  ...
  return (
    ...
    >
      ...
      <span className="z-10 relative bg-linear-to-t dark:from-white dark:to-neutral-500 from-black to-neutral-400 inline-block text-transparent bg-clip-text">
        {children}
      </span>
    </button>
  );
